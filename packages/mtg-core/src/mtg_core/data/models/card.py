...
if TYPE_CHECKING:
    from mtg_core.data.models.responses import ImageUrls, Prices, PurchaseLinks, RelatedLinks
...
class CardImage(BaseModel):
    ...
    def to_image_urls(self) -> ImageUrls:
        ...
        from mtg_core.data.models.responses import ImageUrls
    ...
    def to_prices(self) -> Prices:
        ...
        from mtg_core.data.models.responses import Prices
    ...
    def to_purchase_links(self) -> PurchaseLinks:
        ...
        from mtg_core.data.models.responses import PurchaseLinks
    ...
    def to_related_links(self) -> RelatedLinks:
        ...
        from mtg_core.data.models.responses import RelatedLinks
