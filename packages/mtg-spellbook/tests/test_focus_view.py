...
class TestImageLoading:
    ...
    async def test_load_image_with_valid_url(self, mock_image: Image.Image) -> None:
        ...
        from mtg_spellbook.widgets.art_navigator.image_loader import load_image_from_url
        ...
        class MockAsyncClient:
            ...
            async def get(self, _url: str, timeout: float | None = None) -> MagicMock:  # noqa: ARG002
    ...
    async def test_load_image_with_timeout(self) -> None:
        ...
        # Create async context manager that raises timeout
        class MockAsyncClient:
            async def __aenter__(self) -> MockAsyncClient:
                return self
    ...
    async def test_load_image_replaces_normal_with_large(self, mock_image: Image.Image) -> None:
        ...
        class MockAsyncClient:
            ...
            async def get(self, url: str, timeout: float | None = None) -> MagicMock:  # noqa: ARG002
                nonlocal called_url
                called_url = url
                return mock_response

        # Patch both httpx.AsyncClient and disk cache to ensure network request is made
        with (
